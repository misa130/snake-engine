...
// возвращает направление змеи по направлению ее взгляда
...
// возвращает элементы стены + камни(bad_apple) + змейку
...
// возвращает координаты всей змейки
...
// возвращает координаты камней(bad_apple)
    public List<Point> getStones() {
        return get(Elements.BAD_APPLE);
    }
// возвращает элементы стены
